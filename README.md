...
[![GoDoc](http://img.shields.io/badge/godoc-reference-5272B4.svg)](https://godoc.org/github.com/AlecAivazis/survey/v2)
...
typed string anywhere in their name, ignoring case. This default filtering behavior is provided by the `DefaultFilter`
function.
