...
func TestEditorRender(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			EditorTemplateData{Icons: &defaultIconSet},
		...
		},
		{
			...
			Editor{Message: "What is your favorite month:"},
			EditorTemplateData{Answer: "October", ShowAnswer: true, Icons: &defaultIconSet},
		...
		},
		{
			...
			Editor{Message: "What is your favorite month:", Help: "This is helpful"},
			EditorTemplateData{ShowHelp: true, Icons: &defaultIconSet},
